...
switch($act) {
	...
	case 'add':
		if (isset($_p_pesubmit)) {
			pe_token_match();
			//if (!$cache_setting['web_guestbuy']) pe_jsonshow(array('result'=>false, 'show'=>'Iltimos, avval tizimga kiring...'));
			if (!$_p_user_tname) pe_jsonshow(array('result'=>false, 'show'=>"Iltimos, qabul qiluvchini to'ldiring"));
